...
using netcore5_core.Infrastructure.Bootstrap;
using netcore5_core.Infrastructure.Config;
using netcore5_core.Infrastructure.Middleware;
...
namespace netcore5_webapi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services = StartupBuilder.BuildServices(services);

            services.AddAuthentication("BearerAuthenticationHandler")
